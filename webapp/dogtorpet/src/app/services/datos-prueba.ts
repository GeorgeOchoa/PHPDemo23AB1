...
export let usuarios: Usuario[] = [
  { username:'jromo', password:'12345', email:'jromo@correo.net', nombre:'José', apellidos:'Romo', telefono:'55-5555-5555' },
  { username:'atellez', password:'12345', email:'atellez@correo.net', nombre:'Alejandro', apellidos:'Téllez', telefono:'55-5555-5555' },
  { username:'cgiron', password:'12345', email:'cgiron@correo.net', nombre:'Carlos', apellidos:'Girón', telefono:'55-5555-5555' },
  { username:'snieto', password:'12345', email:'snieto@correo.net', nombre:'Susana', apellidos:'Nieto', telefono:'55-5555-5555' },
  { username:'jvera', password:'12345', email:'jvera@correo.net', nombre:'Jaime', apellidos:'Vera', telefono:'55-5555-5555' }
];

export let tipos: Tipo[] = [
  {id:1, descripcion:'Perro'},
  {id:2, descripcion:'Gato'},
];

export let mascotas: Mascota[] = [
